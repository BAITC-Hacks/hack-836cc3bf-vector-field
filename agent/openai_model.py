...
Каждый finding.text должен содержать не более 300 символов.
В finding.text полностью исключи юридические оценки и слова о преступлении, мошенничестве,
виновности, отмывании, обналичивании, вероятности, риске, управлении, контроле или организаторе,
включая их формы и переводы, ДАЖЕ В ОТРИЦАНИИ: такие формулировки отклоняются валидатором.
Не добавляй в findings юридические оговорки: фиксированное предупреждение и ограничения
интерфейс показывает отдельно. Описывай только наблюдаемые признаки и основания проверки.
